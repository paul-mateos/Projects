...
namespace PatternsInAutomation.Tests.Advanced.Decorator.Basic.Base
{
    ...
    {
        private readonly PatternsInAutomation.Tests.Advanced.Strategy.Basic.Base.IOrderValidationStrategy orderValidationStrategy;

        public PurchaseContext(PatternsInAutomation.Tests.Advanced.Strategy.Basic.Base.IOrderValidationStrategy orderValidationStrategy)
        {
