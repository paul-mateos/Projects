...
namespace FirstFloor.ModernUI.App.Content
{
        ...
        : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            SetPreviousFromRegistry();
        }

        private void SetPreviousFromRegistry()
        {
            CurrentUser = ATACore.RegistryManager.GetUserName();
            string previouslySelectedTheme = ATACore.RegistryManager.GetTheme(CurrentUser);
            string[] colors = ATACore.RegistryManager.GetColors(CurrentUser);
        ...
        public Link SelectedTheme
        {
            ...
            set
            {
                if (this.selectedTheme != value)
                {
                    ...
                    CurrentUser = ATACore.RegistryManager.GetUserName();
                    ATACore.RegistryManager.WriterCurrentThemeToRegistry(CurrentUser, value.DisplayName);
        ...
        public Color SelectedAccentColor
        {
            ...
            set
            {
                if (this.selectedAccentColor != value)
                {
                    ...
                    CurrentUser = ATACore.RegistryManager.GetUserName();
                    ATACore.RegistryManager.WriterCurrentColorsToRegistry(CurrentUser, value.R, value.G, value.B);
