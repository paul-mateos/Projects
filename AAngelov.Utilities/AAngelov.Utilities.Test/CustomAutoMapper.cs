...
{
    /// <summary>
    /// Contains methods that are used to map original object to another DTO object.
    /// </summary>
    /// <typeparam name="T">The original object to be mapped.</typeparam>
    /// <typeparam name="K">The second object that we want to map to.</typeparam>
    public class CustomAutoMapper
    {
        private static CustomAutoMapper instance;
        ...
        /// The instance.
        /// </value>
        public static CustomAutoMapper Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new CustomAutoMapper();
        ...
        /// <summary>
        /// Maps the specified real object.
        /// </summary>
